...
import { Course, SessionWithToken, User } from '@/types';
import {
...
export default function CourseManagement(props: CourseManagementProps) {
  ...
  useEffect(() => {
    (async () => {
      if (!courses[course.id]) {
        ...
        return setActiveCourse(updatedCourse);
      }

      setActiveCourse(courses[course.id]);
    })();
  ...
  return (
    <div className='flex flex-col w-full max-h-full min-h-full p-6 mb-8 overflow-auto bg-white border-2 shadow-xl rounded-xl border-primary-gray border-opacity-40 overscroll-contain scrollbar-hide'>
      ...
      {activeCourse && (
        <div className='flex flex-row flex-nowrap'>
          ...
          <div className='flex flex-col items-center flex-start w-1/2'>
            <div className='flex flex-row justify-around w-full flex-nowrap mb-4'>
